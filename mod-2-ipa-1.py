...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    # Replace `pass` with your code. 
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    material_wasted = total_material - num_jobs * job_consumption
...
def body_mass_index(weight, height):
    ...
    # Replace `pass` with your code. 
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    #weight convert pounds to kg  
    weight_kgs = weight * 0.453592
    #height convert feet to inches
    height_foot = height[0]*12
    #height add inches and feet
    height_inch = height_foot + height[1]
    #height convert inches to m
    height_meter = height_inch * 2.54 / 100
    return(weight_kgs/(height_meter**2))